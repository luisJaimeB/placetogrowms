        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-6">
                ...
                <div class="mt-2 flex items-center">
                    ...
                    <input id="logo" type="file" @change="handleLogoChange($event)" class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
                </div>
