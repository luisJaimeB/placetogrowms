...
<template>
    <div class="min-h-screen flex">
        <!-- Sidebar -->
        <aside
            :class="{'hidden sm:block': !showingNavigationDropdown, 'block': showingNavigationDropdown}"
            class="bg-gray-800 text-white w-64 flex flex-col space-y-6 py-7 px-2"
        >
            <!-- Logo -->
            <div class="flex items-center justify-center h-16 bg-gray-900">
                <Link :href="route('dashboard')" class="text-white flex items-center space-x-2 px-4">
                    <ApplicationLogo class="h-9 w-12 object-cover max-h-full" />
                    <span class="text-1xl font-extrabold">Place To Grow</span>
                </Link>
            </div>
            ...
            <div class="flex flex-col flex-1 overflow-y-auto">
                <nav class="flex-1 px-2 py-4 bg-gray-800">
                    <NavLink
                        ...
                        :class="{
                            'bg-gray-600': route().current('dashboard'),
                        }"
                    >
                    ...
                    <NavLink
                        ...
                        class="flex items-center w-full px-4 py-3 mt-2 text-gray-100 hover:text-gray-300 hover:bg-gray-700 transition-all duration-300"
                        :class="{
                            'bg-gray-600': route().current('payments'),
                        }"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-white h-6 w-6 mr-2" fill="currentColor" viewBox="0 0 512 512">
                    ...
                    <NavLink
                        ...
                        class="flex items-center w-full px-4 py-3 mt-2 text-gray-100 hover:text-gray-300 hover:bg-gray-700 transition-all duration-300"
                        :class="{
                            'bg-gray-600': route().current('users.*'),
                        }"
                        v-if="$page.props.user.permissions.includes('users.index')"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-white h-6 w-6 mr-2" fill="currentColor" viewBox="0 0 640 512">
                    ...
                    <NavLink
                        ...
                        class="flex items-center w-full px-4 py-3 mt-2 text-gray-100 hover:text-gray-300 hover:bg-gray-700 transition-all duration-300"
                        :class="{
                            'bg-gray-600': route().current('roles.*'),
                        }"
                    ...
                    <NavLink
                        ...
                        class="flex items-center w-full px-4 py-3 mt-2 text-gray-100 hover:text-gray-300 hover:bg-gray-700 transition-all duration-300"
                        :class="{
                            'bg-gray-600': route().current('permissions.*'),
                        }"
                        v-if="$page.props.user.permissions.includes('permissions.index')"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-white h-6 w-6 mr-2" fill="currentColor" viewBox="0 0 576 512">
                    ...
                    <NavLink
                        ...
                        :active="route().current('microsites.*')"
                        class="flex items-center w-full px-4 py-3 mt-2 text-gray-100 hover:text-gray-300 hover:bg-gray-700 transition-all duration-300"
                        :class="{
                            'bg-gray-600': route().current('microsites.*'),
                        }"
                        v-if="$page.props.user.permissions.includes('microsites.index')"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-white h-6 w-6 mr-2" fill="currentColor" viewBox="0 0 576 512">
                    ...
                    <NavLink
                        :href="route('acls.index')"
                        :active="route().current('acls.*')"
                        class="flex items-center w-full px-4 py-3 mt-2 text-gray-100 hover:text-gray-300 hover:bg-gray-700 transition-all duration-300"
                        :class="{
                            'bg-gray-600': route().current('acls.*'),
                        }"
                        v-if="$page.props.user.permissions.includes('acls.index')"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-white h-6 w-6 mr-2" fill="currentColor" viewBox="0 0 512 512">
                    ...
                    <NavLink
                        ...
                        class="flex items-center w-full px-4 py-3 mt-2 text-gray-100 hover:text-gray-300 hover:bg-gray-700 transition-all duration-300"
                        :class="{
                            'bg-gray-600': route().current('planes.*'),
                        }"
                        v-if="$page.props.user.permissions.includes('planes.index')"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-white h-6 w-6 mr-2" fill="currentColor" viewBox="0 0 448 512">
                    ...
                    <NavLink
                        ...
                        class="flex items-center w-full px-4 py-3 mt-2 text-gray-100 hover:text-gray-300 hover:bg-gray-700 transition-all duration-300"
                        :class="{
                            'bg-gray-600': route().current('subscriptions.*'),
                        }"
                        v-if="$page.props.user.permissions.includes('subscriptions.index')"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-white h-6 w-6 mr-2" fill="currentColor" viewBox="0 0 512 512">
                    ...
                    <NavLink
                        ...
                        class="flex items-center w-full px-4 py-3 mt-2 text-gray-100 hover:text-gray-300 hover:bg-gray-700 transition-all duration-300"
                        :class="{
                            'bg-gray-600': route().current('invoices.*'),
                        }"
                        v-if="$page.props.user.permissions.includes('invoices.index')"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-white h-6 w-6 mr-2" fill="currentColor" viewBox="0 0 384 512">
